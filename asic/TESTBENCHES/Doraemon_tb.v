...
module Single_Cycle_TB();
   ...
   // This block watches every single write to Data Memory.
   // Our custom software will write `0x000000FF` to address `0x00000064` ONLY if all ISA tests pass.
   always @(negedge clk) begin
      if (MemWrite) begin
         $display("[%0t ns] MEMORY WRITE: Addr = 0x%h | Data = 0x%h (%0d)", $time, DataAddr, WriteData, WriteData);
