...
module tb_Single_Cycle_Top;
    ...
    initial begin
        ...
        $display("==================================================");
        $display("   SMVDU-AHO-32 Processor GLS Started             ");
        $display("==================================================");

        // Assert Reset immediately at time 0
        reset = 1'b1;
        
        // Wait for 100ns (More than 8 full clock cycles)
        #100;  
        
        // Release reset on the negative edge of the clock to prevent race conditions
        @(negedge clk);
        reset = 1'b0;
        ...
        // Give it a few extra cycles to finish the final loop
        #40;
        $display("==================================================");
    ...
    // 5. Watchdog Timer (Failsafe) - Increased for GLS
    initial begin
        #10000; // GLS is slower, giving it 10 microseconds to finish
        $display("==================================================");
