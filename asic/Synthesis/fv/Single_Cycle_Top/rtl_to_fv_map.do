...
# Generated on: Fri May 01 08:30:58 EDT 2026 (Fri May 01 12:30:58 UTC 2026)
...
set logfile fv/Single_Cycle_Top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Single_Cycle_Top -revised fv_map
...
add_search_path ../Golden_Design_RTL/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../Golden_Design_RTL/ALU_Mux.v ../Golden_Design_RTL/ALU.v ../Golden_Design_RTL/Control_Unit.v ../Golden_Design_RTL/ALU_decoder.v ../Golden_Design_RTL/Core_Datapath.v ../Golden_Design_RTL/Data_Memory.v ../Golden_Design_RTL/Extend.v ../Golden_Design_RTL/Main_Decoder.v ../Golden_Design_RTL/PC.v ../Golden_Design_RTL/PC_Mux.v ../Golden_Design_RTL/PC_Plus_4.v ../Golden_Design_RTL/PC_Target.v ../Golden_Design_RTL/Register_File.v ../Golden_Design_RTL/Result_Mux.v ../Golden_Design_RTL/Single_Cycle_Core.v ../Golden_Design_RTL/Instruction_Memory.v ../Golden_Design_RTL/Single_Cycle_Top.v
elaborate_design -golden -root {Single_Cycle_Top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Single_Cycle_Top/fv_map.v.gz
elaborate_design -revised -root {Single_Cycle_Top}
...
#add_name_alias fv/Single_Cycle_Top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Single_Cycle_Top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Single_Cycle_Top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Single_Cycle_Top.rtl.fv_map.rpt
